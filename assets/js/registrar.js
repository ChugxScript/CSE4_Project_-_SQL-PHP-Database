...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('student_search').addEventListener('click', function() {
        ...
        if (searchTerm) {
            searchRow('registrar', searchTerm, s_table, 1);
        } else {
            loadPage('registrar', s_table, 1);
        }
    });
